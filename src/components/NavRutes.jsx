...
const Routes = () => {
    ...
    const navLinks = [
        ...
        subLinks: [
            ...
            { name: "Términos y Condiciones", path: "/empresa/terminos-y-condiciones" },
            { name: "Políticas de Privacidad", path: "/empresa/politicas-de-privacidad" },
        ],
        },
            ...
            <div className="flex items-center gap-6 uppercase">
                ...
                return (
                    ...
                    {hasSubLinks && openDropdown === link.name && (
                        <div className="absolute top-full left-0 z-50 flex w-52 flex-col rounded-md border border-gray-100 bg-white p-2 shadow-lg dark:border-zinc-800 dark:bg-zinc-900 mt-2">
